...
import com.rideflag.app.BitmapUtils
import com.rideflag.app.CameraImageGraphic
import com.rideflag.app.FrameMetadata
import com.rideflag.app.GraphicOverlay
import com.rideflag.app.InferenceInfoGraphic
import com.rideflag.app.ScopedExecutor
import com.rideflag.app.VisionImageProcessor
          ...
          if (!PreferenceUtils.shouldHideDetectionInfo(graphicOverlay.context)) {
            graphicOverlay.add(
              InferenceInfoGraphic(
                ...
                if (shouldShowFps) framesPerSecond else null, results.toString()
              )
            )
            Log.e("Jitinn", "results: "+results.toString())
          }
